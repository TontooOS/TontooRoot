...
run_stage "dock" "${base_dir}/BaseOS/scripts/stage-dock.sh"
run_stage "systemsettings" "${base_dir}/BaseOS/scripts/stage-systemsettings.sh"
run_stage "settingsdaemon" "${base_dir}/BaseOS/scripts/stage-settingsdaemon.sh"
run_stage "systemoverview" "${base_dir}/BaseOS/scripts/stage-systemoverview.sh"
run_stage "aboutthisapp" "${base_dir}/BaseOS/scripts/stage-aboutthisapp.sh"
