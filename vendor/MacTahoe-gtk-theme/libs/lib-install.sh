...
install_shelly() { return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; } # KDE: no GNOME Shell return; }
